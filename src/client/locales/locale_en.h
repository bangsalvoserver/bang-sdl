...
LOCALE_VALUE(GAME_RESOLVE,                        "Resolve")
...
LOCALE_VALUE(GAME_RESTART,                        "Restart")
...
LOCALE_VALUE(STATUS_CHARACTERCHOICE_OTHER,        "{} must chooce their character")
...
LOCALE_VALUE(STATUS_BANG,                         "{0} ... Respond with Mancato or Resolve")
LOCALE_VALUE(STATUS_BANG_MULTIPLE_MISSED,         "{0} ... Respond with {1} Mancato or Resolve")
LOCALE_VALUE(STATUS_BANG_UNAVOIDABLE,             "{0} ... This shot is unavoidable! Respond with Resolve")
LOCALE_VALUE(STATUS_BANG_OTHER,                   "{0} must respond to {1}")
LOCALE_VALUE(STATUS_INDIANS,                      "{0} ... Respond with Bang or Resolve")
LOCALE_VALUE(STATUS_INDIANS_OTHER,                "{0} must respond to {1}")
LOCALE_VALUE(STATUS_DUEL,                         "{0} ... Respond with Bang or Resolve")
LOCALE_VALUE(STATUS_DUEL_OTHER,                   "{0} must respond to {1}")
LOCALE_VALUE(STATUS_DESTROY,                      "{0} to discard {1} ... Respond with Fuga or Resolve")
LOCALE_VALUE(STATUS_DESTROY_OTHER,                "{0} must respond to {1} to discard {2}")
LOCALE_VALUE(STATUS_STEAL,                        "{0} to steal {1} ... Respond with Fuga or Resolve")
LOCALE_VALUE(STATUS_STEAL_OTHER,                  "{0} must respond to {1} to discard {2}")
LOCALE_VALUE(STATUS_DEATH,                        "You're about to die. Play Birra or Resolve")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} is about to die")
LOCALE_VALUE(STATUS_BANDIDOS,                     "{0} ... Discard two cards or Resolve")
...
LOCALE_VALUE(STATUS_RUST,                         "{0} ... Respond with Fuga or Resolve")
LOCALE_VALUE(STATUS_RUST_OTHER,                   "{0} must respond to {1}")
LOCALE_VALUE(STATUS_RICOCHET,                     "{0} on {1} ... Respond with Mancato or Resolve")
...
LOCALE_VALUE(STATUS_CARD_SHARPER,                 "{0} to switch {1} with {2} ... Respond with Fuga or Resolve")
...
LOCALE_VALUE(ERROR_WRONG_DECLARED_SUIT,           "Wrong declared suit")
...
LOCALE_VALUE(ERROR_TARGET_NOT_MISSED,             "You can only play this card on Mancato! cards")
...
LOCALE_VALUE(LOG_DISCARDED_SELF_CARD,             "{0} discards {2}")
...
LOCALE_VALUE(banggame::player_role::sheriff,      "Sheriff")
LOCALE_VALUE(banggame::player_role::deputy,       "Deputy")
LOCALE_VALUE(banggame::player_role::outlaw,       "Outlaw")
LOCALE_VALUE(banggame::player_role::renegade,     "Renegade")

LOCALE_VALUE(banggame::card_expansion_type::characterchoice,      "Character Choice")
LOCALE_VALUE(banggame::card_expansion_type::thebullet,            "The Bullet")
LOCALE_VALUE(banggame::card_expansion_type::dodgecity,            "Dodge City")
LOCALE_VALUE(banggame::card_expansion_type::valleyofshadows,      "Valley of Shadows")
LOCALE_VALUE(banggame::card_expansion_type::wildwestshow,         "Wild West Show")
LOCALE_VALUE(banggame::card_expansion_type::goldrush,             "Gold Rush")
LOCALE_VALUE(banggame::card_expansion_type::armedanddangerous,    "Armed And Dangerous")
LOCALE_VALUE(banggame::card_expansion_type::highnoon,             "High Noon")
LOCALE_VALUE(banggame::card_expansion_type::fistfulofcards,       "Fistful of Cards")
LOCALE_VALUE(banggame::card_expansion_type::canyondiablo,         "Canyon Diablo")
LOCALE_VALUE(banggame::card_expansion_type::ghostcards,           "Ghost cards")
