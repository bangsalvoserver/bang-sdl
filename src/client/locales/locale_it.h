...
LOCALE_VALUE(STATUS_DESTROY_OTHER_FROM_HAND,      "{0} deve rispondere a {1} per scarare una carta dalla mano")
...
LOCALE_VALUE(LOG_DRAWN_ONE_FROM_DISCARD,          "{0} pesca una carta dalla cima degli scarti")
