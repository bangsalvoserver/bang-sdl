...
LOCALE_VALUE(GAME_RESTART,                        "Riavvia")
...
LOCALE_VALUE(banggame::player_role::sheriff,      "Sceriffo")
LOCALE_VALUE(banggame::player_role::deputy,       "Vice")
LOCALE_VALUE(banggame::player_role::outlaw,       "Fuorilegge")
LOCALE_VALUE(banggame::player_role::renegade,     "Rinnegato")
LOCALE_VALUE(banggame::card_expansion_type::characterchoice,      "Scelta dei Personaggi")
LOCALE_VALUE(banggame::card_expansion_type::thebullet,            "La Pallottola")
LOCALE_VALUE(banggame::card_expansion_type::dodgecity,            "Dodge City")
LOCALE_VALUE(banggame::card_expansion_type::valleyofshadows,      "La Valle Delle Ombre")
LOCALE_VALUE(banggame::card_expansion_type::wildwestshow,         "Wild West Show")
LOCALE_VALUE(banggame::card_expansion_type::goldrush,             "Corsa all'Oro")
LOCALE_VALUE(banggame::card_expansion_type::armedanddangerous,    "Armed And Dangerous")
LOCALE_VALUE(banggame::card_expansion_type::highnoon,             "Mezzogiorno di Fuoco")
LOCALE_VALUE(banggame::card_expansion_type::fistfulofcards,       "Per un Pugno di Carte")
LOCALE_VALUE(banggame::card_expansion_type::canyondiablo,         "Canyon Diablo")
LOCALE_VALUE(banggame::card_expansion_type::ghostcards,           "Carte Fantasma")
...
LOCALE_VALUE(ERROR_WRONG_DECLARED_SUIT,           "Seme dichiarato diverso")
...
LOCALE_VALUE(ERROR_MAX_USAGES,                    "Nuon puoi giocare {0} più di {1} volte per turno")
