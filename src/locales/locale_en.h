...
LOCALE_VALUE(PROMPT_TARGET_OWN_HAND,              "You're playing {} on your own hand. Continue?")
...
LOCALE_VALUE(STATUS_DEATH,                        "You can play {} to save yourself")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} can play {1} to escape death")
...
LOCALE_VALUE(ERROR_TARGET_DEAD,                   "Target is dead")
...
LOCALE_VALUE(LOG_PLAYED_CARD_ON_CARD,             "{1} plays {0} on {2}'s {3}")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_HAND,             "{1} plays {0} on {2}'s hand")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_OWN_CARD,         "{1} plays {0} on his own {3}")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_OWN_HAND,         "{1} plays {0} on his own hand")
