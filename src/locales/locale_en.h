...
LOCALE_VALUE(STATUS_CARD_AS_BANG_DMG_STRONG,      "{0} as Bang! ... Respond with {1} Missed or Take {2} damage")
...
LOCALE_VALUE(LOG_MOVED_CUBE,                      "{0} moves a cube from {1} to {2}")
LOCALE_VALUE(LOG_MOVED_CUBES,                     "{0} moves {3} cubes from {1} to {2}")
LOCALE_VALUE(LOG_MOVED_CUBE_FROM,                 "{0} moves a cube from {1}'s {2} to {3}")
LOCALE_VALUE(LOG_MOVED_CUBES_FROM,                "{0} moves {4} cubes from {1}'s {2} to {3}")
LOCALE_VALUE(LOG_PAID_CUBE,                       "{0} pays a cube from {1}")
LOCALE_VALUE(LOG_PAID_CUBES,                      "{0} pays {2} cubes from {1}")
LOCALE_VALUE(LOG_DROP_CUBE,                       "{0} drops a cube from {1}")
LOCALE_VALUE(LOG_DROP_CUBES,                      "{0} drops {2} cubes from {1}")
LOCALE_VALUE(LOG_ADD_CUBE,                        "{0} adds a cube on {1}")
LOCALE_VALUE(LOG_ADD_CUBES,                       "{0} adds {2} cubes on {1}")
