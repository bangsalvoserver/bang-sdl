...
LOCALE_VALUE(game_options::can_play_beer_in_duel,       "Allow Beer in duel")
LOCALE_VALUE(game_options::auto_discard_all,            "Quick Discard All")
LOCALE_VALUE(game_options::scenario_deck_size,          "Scenario Cards")
LOCALE_VALUE(game_options::num_bots,                    "Number of Bots")
LOCALE_VALUE(game_options::damage_timer_ms,             "Damage Timer")
LOCALE_VALUE(game_options::escape_timer_ms,             "Escape Timer")
LOCALE_VALUE(game_options::tumbleweed_timer_ms,         "Tumbleweed Timer")
