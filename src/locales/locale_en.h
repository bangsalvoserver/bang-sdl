...
LOCALE_VALUE(STATUS_BANG_DAMAGE,                  "{0} as Bang! ... Respond with Missed or Take {1} damage")
LOCALE_VALUE(STATUS_BANG_DAMAGE_STRONG,           "{0} as Bang! ... Respond with {1} Missed or Take {2} damage")
