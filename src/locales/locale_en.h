...
LOCALE_VALUE(STATUS_CARD_AS_BANG_MULTIPLE_MISSED, "{0} as Bang! ... Respond with {1} Missed or Take damage")
...
LOCALE_VALUE(STATUS_DEATH,                        "You can play Beer to save yourself")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} can play Beer to escape death")
LOCALE_VALUE(STATUS_DISCARD_ALL,                  "You must discard all your cards")
LOCALE_VALUE(STATUS_DISCARD_ALL_OTHER,            "{0} must discard all their cards")
