...
LOCALE_VALUE(STATUS_CARD_AS_BANG_DMG_STRONG,      "{0} come Bang! ... Rispondi con {1} Mancato o prendi {2} danni")
...
LOCALE_VALUE(LOG_MOVED_CUBE,                      "{0} sposta un cubo da {1} a {2}")
LOCALE_VALUE(LOG_MOVED_CUBES,                     "{0} sposta {3} cubi da {1} a {2}")
LOCALE_VALUE(LOG_MOVED_CUBE_FROM,                 "{0} sposta un cubo da {2} di {1} a {3}")
LOCALE_VALUE(LOG_MOVED_CUBES_FROM,                "{0} sposta {4} cubi da {2} di {1} a {3}")
LOCALE_VALUE(LOG_PAID_CUBE,                       "{0} paga un cubo da {1}")
LOCALE_VALUE(LOG_PAID_CUBES,                      "{0} paga {2} cubi da {1}")
LOCALE_VALUE(LOG_DROP_CUBE,                       "{0} scarta un cubo da {1}")
LOCALE_VALUE(LOG_DROP_CUBES,                      "{0} scarta {2} cubi da {1}")
LOCALE_VALUE(LOG_ADD_CUBE,                        "{0} aggiunge un cubo su {1}")
LOCALE_VALUE(LOG_ADD_CUBES,                       "{0} aggiunge {2} cubi su {1}")
