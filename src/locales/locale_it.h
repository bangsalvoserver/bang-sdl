...
LOCALE_VALUE(STATUS_DEATH,                        "Puoi giocare {} per salvarti")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} può giocare {1} per salvarsi")
...
LOCALE_VALUE(ERROR_TARGET_OWN_HAND,               "Non puoi giocare questa carta sulla tua mano")
