...
LOCALE_VALUE(BUTTON_RESET_SERVERS,                "Reset Indirizzi")
...
LOCALE_VALUE(PROMPT_PASS_DISCARD,                 "Devi scartare {:una carta;{} carte}. Continuare?")
...
LOCALE_VALUE(STATUS_DISCARD_PASS,                 "Scarta {:una carta;{} carte} prima di passare il turno")
LOCALE_VALUE(STATUS_DISCARD_PASS_OTHER,           "{0} deve scartare {1:una carta;{} carte} prima di passare il turno")
LOCALE_VALUE(STATUS_BANG,                         "{0} ... Rispondi con {1:un;{}} Mancato o Prendi {2:un danno;{} danni}")
LOCALE_VALUE(STATUS_BANG_OTHER,                   "{0} deve rispondere a {1}")
LOCALE_VALUE(STATUS_CARD_AS_BANG,                 "{0} come Bang! ... Rispondi con {1:un;{}} Mancato o Prendi {2:un danno;{} danni}")
...
LOCALE_VALUE(STATUS_DEATH,                        "Devi giocare {:una birra;{} birre} per salvarti")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} deve giocare {1:una birra;{} birre} per salvarsi")
...
LOCALE_VALUE(STATUS_SHERIFF_KILLED_DEPUTY_OTH,    "{0} ha ucciso il suo vice e deve scartare tutte le sue carte")
...
LOCALE_VALUE(STATUS_ADD_CUBE,                     "Scegli su quale carta mettere {:un cubetto;{} cubetti}")
LOCALE_VALUE(STATUS_ADD_CUBE_OTHER,               "{0} deve scegliere su quale carta mettere {1:un cubetto;{} cubetti}")
LOCALE_VALUE(STATUS_ADD_CUBE_FOR,                 "Scegli su quale carta mettere {1:un cubetto;{} cubetti}, per {0}")
LOCALE_VALUE(STATUS_ADD_CUBE_FOR_OTHER,           "{0} deve scegliere su quale carta mettere {2:un cubetto;{} cubetti}, per {1}")
...
LOCALE_VALUE(STATUS_DAMAGING,                     "{0} prende {2:un danno;{} danni} per {1}")
LOCALE_VALUE(STATUS_DAMAGING_AS_BANG,             "{0} prende {2:un danno;{} danni} per {1} come Bang!")
LOCALE_VALUE(STATUS_DAMAGING_AS_GATLING,          "{0} prende un danno per {1} come Gatling!")
LOCALE_VALUE(STATUS_REQ_TUMBLEWEED,               "{0} estrae {3} per {2} ... Puoi giocare {1}")
LOCALE_VALUE(STATUS_REQ_TUMBLEWEED_OTHER,         "{0} estrae {3} per {2} ... {4} può giocare {1}")
LOCALE_VALUE(STATUS_REQ_TUMBLEWEED_FOR,           "{0} estrae per {2} ... Puoi giocare {1}")
LOCALE_VALUE(STATUS_REQ_TUMBLEWEED_FOR_OTHER,     "{0} estrae per {2} ... {3} può giocare {1}")
...
LOCALE_VALUE(STATUS_SGT_BLAZE_LOCOMOTIVE_OTH,     "{0} ... {1} può ignorare l'effetto della locomotiva contro un giocatore")
...
LOCALE_VALUE(STATUS_TRAIN_ROBBERY_CHOOSE_OTH,     "{1} ... {0} deve scegliere se scartare {2} o ricevere un Bang")
...
LOCALE_VALUE(ERROR_TARGET_NOT_SELECTION,          "Puoi bersagliare solo carte dalla selezione")
...
LOCALE_VALUE(ERROR_TARGET_NOT_CATBALOU_PANIC,     "Puoi bersagliare solo carte Cat Balou o Panico!")
...
LOCALE_VALUE(ERROR_CANT_PLAY_WHILE_EQUIPPING,     "Non puoi giocare {} mentre equipaggi una carta")
...
LOCALE_VALUE(LOG_DRAWN_CARDS,                     "{0} pesca {1:una carta;{} carte}")
LOCALE_VALUE(LOG_DRAWN_CARD_FOR,                  "{0} pesca {1} per {2}")
LOCALE_VALUE(LOG_DRAWN_CARDS_FOR,                 "{0} pesca {1:una carta;{} carte} per {2}")
...
LOCALE_VALUE(LOG_TAKEN_DAMAGE,                    "{1} prende {2:un danno;{} danni} per {0}")
LOCALE_VALUE(LOG_TAKEN_DAMAGE_AS_BANG,            "{1} prende {2:un danno;{} danni} per {0} come Bang!")
LOCALE_VALUE(LOG_TAKEN_DAMAGE_AS_GATLING,         "{1} prende un danno per {0} come Gatling")
LOCALE_VALUE(LOG_HEALED,                          "{0} si cura di {1:un punto;{} punti} vita")
...
LOCALE_VALUE(LOG_MOVED_CUBE,                      "{0} sposta {3:un cubo;{} cubi} da {1} a {2}")
LOCALE_VALUE(LOG_MOVED_CUBE_FROM,                 "{0} sposta {4:un cubo;{} cubi} da {2} di {1} a {3}")
LOCALE_VALUE(LOG_PAID_CUBE,                       "{0} paga {2:un cubo;{} cubi} da {1}")
LOCALE_VALUE(LOG_DROP_CUBE,                       "{0} scarta {2:un cubo;{} cubi} da {1}")
LOCALE_VALUE(LOG_ADD_CUBE,                        "{0} aggiunge {2:un cubo;{} cubi} su {1}")
