...
LOCALE_VALUE(STATUS_BANG_MULTIPLE_MISSED,         "{0} ... Rispondi con {1} Mancato o prendi danno")
LOCALE_VALUE(STATUS_BANG_UNAVOIDABLE,             "{0} ... Il colpo non può essere annullato!")
...
LOCALE_VALUE(STATUS_CARD_AS_BANG_MULTIPLE_MISSED, "{0} come Bang! ... Rispondi con {1} Mancato o prendi danno")
LOCALE_VALUE(STATUS_CARD_AS_BANG_UNAVOIDABLE,     "{0} come Bang! ... Il colpo non può essere annullato!")
...
LOCALE_VALUE(STATUS_DESTROY_OTHER_FROM_HAND,      "{0} deve rispondere a {1} per scartare una carta dalla mano")
...
LOCALE_VALUE(STATUS_RICOCHET,                     "{0} su {1} ... Puoi rispondere con Mancato")
