...
LOCALE_VALUE(STATUS_DEATH,                        "Puoi giocare Birra per salvarti")
LOCALE_VALUE(STATUS_DEATH_OTHER,                  "{0} può giocare Birra per salvarsi")
LOCALE_VALUE(STATUS_DISCARD_ALL,                  "Devi scartare tutte le tue carte")
LOCALE_VALUE(STATUS_DISCARD_ALL_OTHER,            "{0} deve scartare tutte le sue carte")
