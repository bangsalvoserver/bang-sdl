...
LOCALE_VALUE(LOG_PLAYED_CARD_ON_CARD,             "{1} gioca {0} su {3} di {2}")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_HAND,             "{1} gioca {0} sulla mano di {2}")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_OWN_CARD,         "{1} gioca {0} sulla sua {3}")
LOCALE_VALUE(LOG_PLAYED_CARD_ON_OWN_HAND,         "{1} gioca {0} sulla sua mano")
