...
LOCALE_VALUE(game_options::can_play_beer_in_duel,       "Permetti Birra in duello")
LOCALE_VALUE(game_options::auto_discard_all,            "Scarta Tutto Veloce")
LOCALE_VALUE(game_options::scenario_deck_size,          "Carte Scenario")
LOCALE_VALUE(game_options::num_bots,                    "Numero di Bot")
LOCALE_VALUE(game_options::damage_timer_ms,             "Timer di Danno")
LOCALE_VALUE(game_options::escape_timer_ms,             "Timer di Fuga")
LOCALE_VALUE(game_options::tumbleweed_timer_ms,         "Timer di Cespuglio")
